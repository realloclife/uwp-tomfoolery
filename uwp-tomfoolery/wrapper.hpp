...
namespace rbx {
	inline auto get_scheduler() noexcept -> scheduler {
		return scheduler{ reinterpret_cast<auto (__cdecl*)()->uintptr_t>(address::get_scheduler_singleton)() };
	}
	...
	inline auto get_lua_state(uintptr_t script_context) noexcept -> uintptr_t {
		...
		auto get_global_state = reinterpret_cast<auto (__thiscall*)(uintptr_t, uintptr_t, uintptr_t)->uintptr_t>(address::get_global_state);
	...
	inline auto vm_load(uintptr_t lua_state, std::string* bytecode) noexcept -> int32_t {
		return reinterpret_cast<auto (__fastcall*)(uintptr_t, std::string*, const char*, uintptr_t)->int32_t>(address::vm_load)(lua_state, bytecode, "", 0x0);
	}

	inline auto task_defer(uintptr_t lua_state) noexcept -> uintptr_t {
		return reinterpret_cast<auto (__cdecl*)(uintptr_t)->uintptr_t>(address::task_defer)(lua_state);
	}
}
